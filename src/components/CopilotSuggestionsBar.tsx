  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop offset="0.0955758" stopColor="#00AEFF" /> /* SVG gradient — exempt */
          <stop offset="0.773185" stopColor="#2253CE" /> /* SVG gradient — exempt */
          <stop offset="1" stopColor="#0736C4" /> /* SVG gradient — exempt */
        </radialGradient>
        <radialGradient
          id={id('p1')}
          cx="0"
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#FFB657" /> /* SVG gradient — exempt */
          <stop offset="0.633728" stopColor="#FF5F3D" /> /* SVG gradient — exempt */
          <stop offset="0.923392" stopColor="#C02B3C" /> /* SVG gradient — exempt */
        </radialGradient>
        <radialGradient
          id={id('p2')}
          cx="0"
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0.03" stopColor="#FFC800" /> /* SVG gradient — exempt */
          <stop offset="0.31" stopColor="#98BD42" /> /* SVG gradient — exempt */
          <stop offset="0.49" stopColor="#52B471" /> /* SVG gradient — exempt */
          <stop offset="0.843838" stopColor="#0D91E1" /> /* SVG gradient — exempt */
        </radialGradient>
        <linearGradient
          id={id('p3')}
          x1="9.52186"
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#3DCBFF" /> /* SVG gradient — exempt */
          <stop offset="0.246674" stopColor="#0588F7" stopOpacity="0" /> /* SVG gradient — exempt */
        </linearGradient>
        <radialGradient
          id={id('p4')}
          cx="0"
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0.0661714" stopColor="#8C48FF" /> /* SVG gradient — exempt */
          <stop offset="0.5" stopColor="#F2598A" /> /* SVG gradient — exempt */
          <stop offset="0.895833" stopColor="#FFB152" /> /* SVG gradient — exempt */
        </radialGradient>
        <linearGradient
          id={id('p5')}
          x1="28.6736"
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0.0581535" stopColor="#F8ADFA" /> /* SVG gradient — exempt */
          <stop offset="0.708063" stopColor="#A86EDD" stopOpacity="0" /> /* SVG gradient — exempt */
        </linearGradient>
      </defs>
    </svg>
  );
